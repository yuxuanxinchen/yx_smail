...
import yygl.business.dao.mapper.GysypmlControlMapper;
import yygl.business.dao.mapper.GysypmlMapper;
import yygl.business.dao.mapper.GysypmlMapperCustom;
...
import yygl.business.pojo.po.GysypmlControlExample;
import yygl.business.pojo.po.GysypmlExample;
...
public class YpmlServiceImpl implements YpmlService {
	...
	public void deleteGysypml(String usergysid, String ypxxid) throws Exception {
		...
		String id = gysypml.getId();//得到了要删除供货商药品目录记录的主键
