...
<body>
      ...
      <h1 style="text-align:center">项目审批</h1>
 <table width="100%" height="48" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#aaaaaa"  bordercolorlight="#FFFFFF">
			  ...
			  <s:iterator value="#request.pm" id="p">
			   <tr bgcolor="#eeeeee" style="padding:5px;">
				      ...
				      <td align="center"> <strong style="font-size:18px;font-family:'微软雅黑';color:red">
				           <s:if test="#p.projectVerify == 1">
				              	 未审核
				           </s:if>
							 </strong>
						</td>
						<td align="center"> <a id="datils" href="#" onclick="submitVerify(${p.projectId})">提交审核</td>
			  </tr>
			</s:iterator>
