...
.containfo {
  ...
  <center>
		 <h2 align="center" style="font-family:华义彩云;"> 日程添加</h2>
			<form name="addComplainInfoForm"   action=" " method="post" target="main">
			      <table width="55%" height="48" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#aaaaaa"  bordercolorlight="#FFFFFF">
				    ...
				    <tr style="padding:5px;">
				      ...
				      <td><input type="text" placeholder="填写主题哦" name="shecduleName" id="shecduleName" value=""> </td>
					  ...
					  <tr style="padding:5px;">
					   ...
					   <td bgcolor="#eeeeee"> 任务：</td>
					      <td align="left">
					      <input type="text" placeholder="单击添加哦" name="MissionName" onclick="showMission()" id="MissionName" readonly="readonly" value=""> 
					      <input type="hidden" name="missionId" id="missionId" readonly="readonly" value=""> 
					      
					      </td>
					      
					
					  <td bgcolor="#eeeeee"> 结束时间：</td>
				      <td><input type="text" id="resultTime" />
					    <tr style="padding:5px;">
					  ...
					  <tr style="padding:5px;">    
						      ...
						      <td align="left"  colspan="3"> 
						          <textarea rows="5" cols="60" name="shceduleDescription" id="shceduleDescription"></textarea>
						      </td>
					  </tr>  
