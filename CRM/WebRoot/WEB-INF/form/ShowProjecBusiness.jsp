...
<script type="text/javascript">
     function allCheckBox() {
	  ...
	  function submitBusiness(obj){
	     project.updataBusiness(obj,{
...
<body>
      ...
      <h1 style="text-align:center">交易列表</h1>
 <table width="100%" height="48" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#aaaaaa"  bordercolorlight="#FFFFFF">
	          <tr bgcolor="#eeeeee" style="padding:5px;">
				      ...
				      <td align="center"> 项目交易</td>
				      <td align="center"> 项目描述</td>
				       <td align="center"> 完成交易</td>
			  ...
			  <s:iterator value="#request.pm" id="p">
			   <tr bgcolor="#eeeeee" style="padding:5px;">
				      ...
				      <td align="center"> 
						...
						<s:if test="#p.projectBusiness == 1">
						<td align="center"> <a href="#" id="datils" onclick="submitBusiness(${p.projectId})">提交完成</a></td>
			  			</s:if>
			  				<s:if test="#p.projectBusiness == 2">
						<td align="center"> <a href="#"  >完成交易</a></td>
			  			</s:if>
			  </tr>
				  ...
				  <td colspan="12" align="center">
				      <s:if test="#request.page.currentPage">
				         <a href="pc/prbusiness.action?currentPage=1">首页</a>
				         <a href="pc/prbusiness.action?currentPage=${request.currentPage-1}">上一页</a>
				      </s:if>
				      <s:else>
				       首页
				       上一页
				       ...
				       <s:if test="#request.page.hasNextPage">
				         <a href="pc/prbusiness.action?currentPage=${request.currentPage+1}">下一页</a>
				         <a href="pc/prbusiness.action?currentPage=${request.page.totalPage }">尾页</a>
				      </s:if>
				      <s:else>
				       下一页
				       尾页
