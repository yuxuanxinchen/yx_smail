...
<script type="text/javascript">
	function AjaxSubmit() {
		...
		customerInfo.saveCustomerInfo(formMap,{
...
<body>
	...
	<form action="sjzd/addCustomerInfo.action" name="customerInfoForm" method="post" target="main">
		<table width="100%" height="48" border="1" cellpadding="0"
			...
			<tr style="padding:5px;">
				...
				<td><input type="text" name="customerName" value=""><font
					color="red">${requestScope.error }</font></td>
		...
		<p align="center">
			<input type="button" onclick="AjaxSubmit()" value="提交" style='display:bolck;width:100%;height:50px;background:#141414;color:#fff;font-size:30px;line-height:50px;text-align:center;letter-space:1em;box-shadow:3px 4px 5px #141414;border-radius:10px;cursor:pointer' /> 
			<input type="reset" value="重置" style='display:bolck;width:100%;height:50px;background:#141414;color:#fff;font-size:30px;line-height:50px;text-align:center;letter-space:1em;box-shadow:3px 4px 5px #141414;border-radius:10px;cursor:pointer'/>
		</p>
	</form>
</body>
</html>
